...
export default function App() {
  ...
  return (
    <div className="relative items-center justify-center h-screen bg-black sm:flex">
      <div className="absolute bottom-0 w-full sm:h-min sm:w-[600px] sm:relative bg-darkGrey rounded-t-xl sm:rounded-xl max-h-[calc(100vh-20%)] overflow-y-scroll sm:overflow-auto  ">
